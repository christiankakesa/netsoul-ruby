...
describe Netsoul do
  it 'have a version number'.freeze do
    expect(Netsoul::VERSION).not_to be nil
  end

  it 'Logger works with composition paradigm'.freeze do
    class LogOlder
  ...
  it 'Location gives the IONIS internal location or "ext"'.freeze do
  ...
  it 'Config have a default values set'.freeze do
  ...
  describe 'Message handling'.freeze do
    it 'returns standard_auth message'.freeze do
    ...
    it 'returns kerberos_auth message'.freeze do
    ...
    it 'returns stop_writing_to_user message'.freeze do
    ...
    it 'returns list_users message'.freeze do
    ...
    it 'returns a xfer_accept message'.freeze do
    ...
    it 'returns a xfer_data message'.freeze do
    ...
    it 'returns a xfer_cancel message'.freeze do
